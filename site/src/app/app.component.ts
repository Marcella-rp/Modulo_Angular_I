...
import { InputSearchValues } from './models/header-input-data.model';
...
export class AppComponent {
  ...
  onContactFormSubmitted(inputData: InputSearchValues): void {
    console.log("Oba! Busca realizada com sucesso", inputData);
  }
